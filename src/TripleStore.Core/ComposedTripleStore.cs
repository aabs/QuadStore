...
{
    private Dictionary<int, PropertyStore> stores = new();
    ...
    public struct Enumerator
    {
        ...
        public override int GetHashCode() => ctStore.Stores.SelectMany(x => x.Value).Aggregate(0, (a, x) => a ^ x.GetHashCode());
    }

    private class EnumeratorImpl : IEnumerator<Triple>
    {
        private readonly Enumerator _en;
