...
- [x] 1. Scaffold the new library project and update the solution file
  - [x] 1.1 Create `src/QuadStore.SparqlServer/QuadStore.SparqlServer.csproj`
  ...
  - [x] 1.2 Add `QuadStore.SparqlServer` to `QuadStore.sln` under the `Src` solution folder
...
- [x] 3. Implement library source files
  - [x] 3.1 Create `src/QuadStore.SparqlServer/SparqlResultSerializer.cs`
  ...
  - [x] 3.2 Create `src/QuadStore.SparqlServer/SparqlQueryHandler.cs`
    - Internal static class in namespace `TripleStore.SparqlServer`
  ...
  - [x] 3.3 Create `src/QuadStore.SparqlServer/GraphStoreHandler.cs`
    - Internal static class in namespace `TripleStore.SparqlServer`
  ...
  - [x] 3.4 Create `src/QuadStore.SparqlServer/SparqlEndpointRouteBuilderExtensions.cs`
...
- [x] 4. Checkpoint — Verify library compiles
...
- [x] 5. Refactor the sample app to use the library
  - [x] 5.1 Update `samples/SparqlServerOverMinimalApi/SparqlServerOverMinimalApi.csproj`
  ...
  - [x] 5.2 Simplify `samples/SparqlServerOverMinimalApi/Program.cs`
...
- [x] 6. Checkpoint — Verify sample app builds and existing tests pass
...
- [x] 7. Retarget test project and add new tests
  - [x] 7.1 Add library project reference to `test/QuadStore.Tests/QuadStore.Tests.csproj`
  ...
  - [x] 7.2 Add new integration tests to `test/QuadStore.Tests/SparqlServerTests.cs`
  ...
  - [x] 7.3 Write property test for SPARQL Update always returns 501
  ...
  - [x] 7.4 Write property test for Graph Store write operations return 501
  ...
  - [x] 7.5 Write property test for Graph Store GET returns Turtle content type
